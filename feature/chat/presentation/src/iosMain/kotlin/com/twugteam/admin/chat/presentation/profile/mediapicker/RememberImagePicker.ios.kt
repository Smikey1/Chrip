        ...
        object : NSObject(), PHPickerViewControllerDelegateProtocol {
            override fun picker(
                ...
                for (result in results) {
                    ...
                    val typeIdentifier = itemProvider.registeredTypeIdentifiers
                    val primaryType = typeIdentifier.firstOrNull() as? String
                    if (primaryType == null) {
                        ...
                        scope.launch {
                            nsData?.let {
                                ...
                                withContext(Dispatchers.Default) {
                                    // copying all the bytes form c-pointer reference
